    ...
    public class Scenario
    {
        ...
        public static void Run(string scenario_b64)
        {
            ...
            try
            {
                ...
                dynamic scenario_torun = JsonConvert.DeserializeObject<TTPs>(scenario_text);

                Console.WriteLine("Adversary emulation is starting...");

                foreach (dynamic item in scenario_torun.scenario)
                {
                ...
                string scenario_report = JsonConvert.SerializeObject(scenario_torun);
